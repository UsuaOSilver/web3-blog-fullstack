...
contract Blog {
    ...
    /** her we create loopups for posts by id and posts by ipfs hash */
    mapping(uint => Post) private idToPost;
    mapping(string => Post) private hashToPost;
    
    /** events facilitate communication between smart contract and their user interfaces */
    /** i.e. we can create listeners for event in the clients and also use them in the Graph  */
    ...
    /** fetcges an individuals post by the content hash */

...
import Blog from '../../artifacts/Blog.sol/Blog.json'
...
export async function getStaticPaths() {
    ...
    let provider
    if (process.env.EMVIRONMENT === 'local') {
    ...
    /** then we map over the posts and create a params objects passing */
    /** the id prop to getStaticProps which will run for ever post */
...
export async function getStaticProps({ params }) {
    /** using the id prop passed in through the paraams object */
    /** we can use it to fetch the data from IPFS and pass the */
